...
?>
    ...
    <div class="poster">        
        <img src="movies1.jpg" alt="">
        <div>
            <form method="post" action="favorite_add.php">
                <!-- Pass movieID instead of movie name -->
                <input type="hidden" name="movieID" value="1"> <!-- Replace '1' with the actual movieID for "How To Make Millions Before Grandma Dies" -->
    ...
    <div class="main" id="main">
        <h1><span>How To Make Millions Before Grandma Dies</span></h1>
        ...
        <p><strong>Release Date:</strong> 30 July 2024</p>
    ...
    <div class="trailer" id="trailer">
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/HrVX_nHNIUA?si=fxyfybj6e3j27SLi" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
