...
?>
    ...
    <div class="main" id="main">
        <h1><span>I Not Stupid 3</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "Zi Hao, a Chinese Primary 6 student in Singapore, faces academic pressure 
            when his classmate Jayden frames him for cheating to maintain his top-ranking status. 
            Meanwhile, Zi Hao`s mother, Wen Ting, is falsely accused of illegal work by Jayden`s 
            competitive mother, Sophia. Amidst the turmoil, the two mothers realise the toll on their 
            sons and unite to prioritise their well-being over grades, fostering reconciliation."
        </p>
        <p><strong>Release Date:</strong> 13 Jun 2024</p>
        <p><strong>Director:</strong>  Jack Neo</p>
        <p><strong>Cast:</strong> Zhou Yuchen, Goh Wee-Ann, Jiang Songheng, Huang Zhiyang, Glenn Yong, Collin Chee, Terence Cao, Patricia Mok, Jae Liew</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/Rxur-zQLcj8?si=lFWK4nU-gNyIir76" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
