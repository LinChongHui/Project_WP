...
?>
    ...
    <div class="main" id="main">
        <h1><span>Junkyard Dog</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "Childhood pals Dog and Mirales live in a little village in the 
            south of France and spend their days roaming the streets. To kill 
            time, Mirales has got into the habit of teasing Dog mercilessly. 
            Their friendship will be tested when Dog meets Elsa and romance blossoms. 
            Consumed by jealousy, Mirales will have to break away from his past in order
             to grow and find his place."
        </p>
        <p><strong>Release Date:</strong> 30 May 2024</p>
        <p><strong>Director:</strong> Jean-Baptiste Durand</p>
        <p><strong>Cast:</strong> Anthony Bajon, Raphaël Quenard, Galatéa Bellugi, Dominique Reymond</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/V5sg0YDlo6w?si=gwt3u4yviBBe0WmU" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
