...
?>
    ...
    <div class="main" id="main">
        <h1><span>Zim Zim Ala Kazim</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "A group of ghost hunters often get together to investigate paranormal activities. 
            During one of their search missions, they encountered something strange and it led them 
            to the conclusion that Ustaz Kazim is in danger. Their new mission now is to save the ustaz."
        </p>
        <p><strong>Release Date:</strong> 13 Jun 2024</p>
        <p><strong>Director:</strong> Asmawi Ani</p>
        <p><strong>Cast:</strong> Along Cham, Ustaz Kazim Elias, Zarina Anjoulie, Asmawi Ani, Bell Ngasri</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/OjxLi-p3rks?si=5aEj_ZrLVCeT2KCA" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
