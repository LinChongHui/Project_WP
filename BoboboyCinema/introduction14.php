...
?>
    ...
    <div class="main" id="main">
        <h1><span>The Animal Kingdom</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "In a world plagued by a wave of mutations that are gradually transforming some humans into animals, 
            François does everything to save his wife, affected by this mysterious illness. While the region is 
            populated by creatures of a new kind, he embarks Émile, their 16-year-old son, on a quest that will 
            change their existence forever."
        </p>
        <p><strong>Release Date:</strong> 30 May 2024</p>
        <p><strong>Director:</strong> Thomas Cailley</p>
        <p><strong>Cast:</strong> Romain Duris, Paul Kircher, Adèle Exarchopoulos, Tom Mercier</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/GgB7smBkk4I?si=O0GkT_rA8Fy3YUsm" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
