...
<head>
    ...
    <title>The Taste of Things</title>
...
?>
    ...
    <div class="main" id="main">
        <h1><span>The Taste of Things</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "1885. Eugenie worked as a chef for the famous restaurant owner Dodin for 20 years. She 
            is considered excellent in her field. Over the years, because Eugenie and Dodin spent a 
            lot of time in the kitchen together, feelings arose between them. Their shared love of food 
            has created unique, delicious and exquisite dishes that are second to none and attract many diners 
            from all over the world. However, freedom-loving Eugenie never wanted to marry Dodin. Then, Dodin decided to 
            cook for his beloved for the first time."
        </p>
        <p><strong>Release Date:</strong> 30 May 2024</p>
        <p><strong>Director:</strong> Tran Anh Hung</p>
        <p><strong>Cast:</strong> Juliette Binoche, Benoit Magimel</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/cKKCGtoIOVY?si=03qilFBKkDTUNrvE" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
