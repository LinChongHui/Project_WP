...
?>
    ...
    <div class="main" id="main">
        <h1><span>The Experts</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "After a decade of hard-earned peace, ex-criminal siblings are ruthlessly dragged 
            back into their treacherous past. A notorious gangster`s blackmail forces them into a 
            heart-pounding heist, where old grudges ignite, and a shocking family tragedy resurfaces. 
            As the shadows of their criminal history engulf them, loyalties fray, and survival hangs in 
            the balance. Will they outsmart their ruthless enemy and protect the family, or will this desperate 
            job tear them apart forever?"
        </p>
        <p><strong>Release Date:</strong> 23 May 2024</p>
        <p><strong>Director:</strong> Nazim Shah, Andre Chiew</p>
        <p><strong>Cast:</strong>  Aaron Aziz, Syafiq Kyle, Remy Ishak, Mimi Lana, Ray Dapdap, Wan Hanafi Su, Tony Eusoff</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/_CYSD6Je2xY?si=Hnr3RKShAHs08ssw" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
