...
?>
    ...
    <div class="main" id="main">
        <h1><span>Sinakagon</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "Directed by Timothy Stephen, the film is inspired by the story and legend of Huminodun, and is in the Dusun language."
        </p>
        <p><strong>Release Date:</strong> 13 Jun 2024</p>
        <p><strong>Director:</strong> Timothy Stephen</p>
        <p><strong>Cast:</strong> Ejin Dinting, Fiona Josepher, Lisa Christie, Esthaer Zaino</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/klkHZ2U9oAA?si=OChicTLDTvjeVH6J" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
