...
?>
    ...
    <div class="main" id="main">
        <h1><span>A Chance To Win</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "In the picturesque South of France, two villages have long been rivals. Particularly 
            when it comes to rugby. As their 100th match nears, the arrival of asylum seekers injects a new 
            dynamic into village life. Where some villagers harbour suspicion, others see opportunity and the newcomers are enlisted to bolster chances of victory on the field."
        </p>
        <p><strong>Release Date:</strong> 30 May 2024
        </p>
        <p><strong>Director:</strong> Philippe Guillard</p>
        <p><strong>Cast:</strong> Olivier Marchal, Olivia Bonamy, Mathieu Madénian, Solène Hébert, Philippe Duquesne, Patrick Sébastien</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/tQSHSX60x_o?si=EadhKnw1aXAVGboy" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
