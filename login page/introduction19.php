...
<head>
    ...
    <title>Detective Conan Vs. Kid The Phantom Thief</title>
...
?>
    ...
    <div class="main" id="main">
        <h1><span>Detective Conan Vs. Kid The Phantom Thief</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "The greatest child detective in the world finally meets his match with the emergence of
             a flamboyant magic-wielding master thief known as Kaito Kid."
        </p>
        <p><strong>Release Date:</strong> July 30, 2024</p>
        <p><strong>Director:</strong>Shunsuke Ishihara</p>
        <p><strong>Cast:</strong> Minami Takayama, Kappei Yamaguchi, Wakana Yamazaki
        </p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/DHJrkN_GeX8?si=WuyKp-t7MgSFgX9A" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
