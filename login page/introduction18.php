...
?>
    ...
    <div class="main" id="main">
        <h1><span>Kingdom Of The Planet Of The Apes</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "Many ape clans have emerged in the oasis where Caesar led his fellow apes to, 
            while humans have regressed into a feral state. One ape leader perverts the teachings 
            of Caesar to enslave other clans in search of the last traces of a secret human technology, while another ape embarks on a journey to find freedom side by side with a human girl."
        </p>
        <p><strong>Release Date:</strong> 9 May 2024</p>
        <p><strong>Director:</strong> Wes Ball</p>
        <p><strong>Cast:</strong>Owen Teague, Freya Allan, Kevin Durand, Peter Macon, William H. Macy</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/XtFI7SNtVpY?si=K8JBdyZwwP5Qjvx6" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
