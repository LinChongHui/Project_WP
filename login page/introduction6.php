...
?>
    ...
    <div class="main" id="main">
        <h1><span>Twilight Of The Warriors: Walled In</span></h1>
        <h2>About the Movie : </h2>
        <p>
            "Troubled youth Chan, who accidentally enters the Walled City, discovers the 
            order amidst its chaos, and learns important life lessons along the way. He becomes 
            close friends with Shin, Twelfth Master and AV. Under the leadership of Tornado, they 
            resist against the invasion of villain Mr Big in a series of fierce battles. Together, 
            they vow to protect the city, which they have come to regard as their safe haven."
        </p>
        <p><strong>Release Date:</strong> 17 May 2024</p>
        <p><strong>Director:</strong> Cheang Pou Soi</p>
        <p><strong>Cast:</strong>  Louis Koo, Sammo Hung, Richie Jen, Raymond Lam Fung</p>
        <div class="rating">
    ...
    <div class="trailer" id="trailer">
        ...
        <div class="watch-trailer">
            <a href="https://www.youtube.com/embed/Dn6FH6G3pUo?si=X9gPOd1p_uV4osnK" class="watch-trailer" target="_blank">Watch Trailer</a>
        </div>
